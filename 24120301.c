//Exemplo de  em C, incluindo:.....
/*
no exemplo de árvore binária, na remoção lidamos com tres casos:
a) nó sem filho - apenas remove o no
b) no com filho - substitui o no pelo filho
c) no com dois filhos - substitui o valor pelo menor valor da subarvore direita(ou o maior a esquerda) e remove o no substituto
*/
#include <stdio.h>
#include <stdlib.h>
#include <locale.h>
